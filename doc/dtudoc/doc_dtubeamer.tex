	...
	\begin{columns}[T, onlytextwidth]
		\begin{column}{.475\textwidth}
			\begin{tcolorbox}[title={Framed blocks}]\raggedright
				...
				%			\begin{tcolorbox}[title={Default}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=dtured,title={Red}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=dtugrey,title={Grey}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=dtudarkgreen,title={Green}]\end{tcolorbox}
				%		\end{minipage}
				%		\begin{minipage}[c]{0.45\textwidth}
				%			\begin{tcolorbox}[colframe=dtudarkblue,title={Blue}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=dtuorange,title={Orange}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=dtuviolet,title={Violet}]\end{tcolorbox}
				%			\begin{tcolorbox}[colframe=ipugreen,title={IPU Green}]\end{tcolorbox}
				%		\end{minipage} 
			\end{tcolorbox}
		\end{column}
		\begin{column}{.475\textwidth}
			\begin{tcolorbox}[colback=white, colframe=dtured, title={Custom block}]\raggedright
